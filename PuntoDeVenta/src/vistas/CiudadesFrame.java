...
public class CiudadesFrame extends JFrame {
	...
	JComboBox<Provincia> comboBoxProvincia = new JComboBox<Provincia>(new Provincia().listar().toArray(new Provincia[0]));
	JComboBox<Pais> comboBoxPais = new JComboBox<Pais>(new Pais().listar().toArray(new Pais[0]));
